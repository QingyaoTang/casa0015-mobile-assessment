<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['appservice:history:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['appservice:history:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['appservice:history:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['appservice:history:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="historyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="记录id" align="center" prop="historyId" />
      <el-table-column label="时长单位分钟" align="center" prop="time" />
...
<script>
import { listHistory, getHistory, delHistory, addHistory, updateHistory } from "@/api/appservice/history";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除app使用记录编号为"' + historyIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('appservice/history/export', {
        ...this.queryParams
